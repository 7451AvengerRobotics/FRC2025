...
public class RobotConstants {
    ...
    public static class IntakeConstants{
        ...
        public static final double intakePivotkV = 4; // A velocity target of 1 rps results in 0.12 V output
        public static final double intakePivotkA = 0.01; // An acceleration of 1 rps/s requires 0.01 V output
        public static final double intakePivotkP = 45; // A position error of 0.2 rotations results in 12 V output
    ...
    public static class ClawConstants{
        ...
        public static final double kClawGearRatio = 100;
        public static final double clawPivotkS = 0.25; // Add 0.25 V output to overcome static friction
        public static final double clawPivotkV = 5; // A velocity target of 1 rps results in 0.12 V output
        public static final double clawPivotkA = 0.01; // An acceleration of 1 rps/s requires 0.01 V output
        public static final double clawPivotkP = 55; // A position error of 0.2 rotations results in 12 V output
    ...
    public static class ElevatorConstants {
        ...
        public static final double elevatorkV = 1.44; // A velocity target of 1 rps results in 0.12 V output
