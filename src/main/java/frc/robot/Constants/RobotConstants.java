...
public class RobotConstants {
    ...
    public static class IntakeConstants{
        ...
        public static final double intakePivotkP = 50; // A position error of 0.2 rotations results in 12 V output
    ...
    public static class ClawPivotConstants{
        ...
        public static final double kClawPivotGearRatio = 75;
        public static final double clawPivotkS = 0.1; // Add 0.25 V output to overcome static friction
        ...
        public static final double clawPivotkG = 0.33; 
    }
